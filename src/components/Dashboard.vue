<!--    <template>-->
<!--        <div>-->
<!--            &lt;!&ndash; game-available section &ndash;&gt;-->
...
<!--                                                            <option selected>Please select delivery type</option>-->
...
<!--                                                    </td>-->
<!--                                                </tr>-->
<!--                                                <tr v-if="form.deliveryType ==='home'">-->
...
<!--            methods: {-->
<!--              selected() {-->
<!--                console.log(this.form.deliveryType, 'delivery');-->
<!--              },-->
<!--                setModalData(rent) {-->
<!--                  this.modalData = rent;-->
