...
<!--                                <li v-for="(asset,index) in game.assets.data" :key="index" :id="'slide'+index"><img :src="asset.url" alt="jedi fallen" class="img-fluid"/></li>-->
<!--                            </ul>-->
<!--                        </div>-->
<!--                        <div class="row">-->
...
<!--                            </div>-->
<!--                            &lt;!&ndash; screenshots section &ndash;&gt;-->
