            ...
            <div class="container">
                ...
                <div class="d-grid grid-md-cols-5 col-gap-30">
                    <a href="#">
                        ...
                        <p class="d-flex align-items-center text-secondery">Details 
                            <svg class="ml-4" width="24" height="15" viewBox="0 0 24 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="text-center mt-5">
                    <a href="#" class="border-1 border-secondery-opa-25 text-secondery py-2 pl-a-6 pr-a-6 d-inline-block">All post</a>
                </div>
            </div>
        </section>
