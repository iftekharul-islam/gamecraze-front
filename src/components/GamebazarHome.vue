    ...
    <div>
                ...
                <div class="row align-items-lg-center">
                    <div class="col-lg-7">
                        <div class="max-600">
                            ...
                            <a href="#" @click.prevent="routeOnSellPost" class="router_link btn--collision br-40 border-1 secondery-border gil-bold font-weight-bold py-2 pl-a-6 pr-a-6 d-inline-block position-relative">
        ...
        <section class="new-post pb-a-11 pt-a-9">
            ...
            <div class="container pr-a-0-max-575">
                ...
                <div class="text-center mt-5">
                    <router-link to="/sell-posts" class="router_link btn--collision br-40 border-1 secondery-border gil-bold font-weight-bold py-2 pl-a-6 pr-a-6 d-inline-block position-relative">{{ $t('all_post', $store.state.locale) }}</router-link>
                </div>
            </div>
        </section>
        <div v-if="categories.length">
          <section class="new-post pb-a-11" v-for="(category, index) in categories" :key="index">
            <div class="container">
              ...
              <div class="text-center mt-5">
                <a href="#" @click.prevent="queryOnCategory(category.name)" class="router_link btn--collision br-40 border-1 secondery-border gil-bold font-weight-bold py-2 pl-a-6 pr-a-6 d-inline-block position-relative">{{ $t('all_post', $store.state.locale) }}</a>
              </div>
            </div>
          </section>
        </div>
        ...
        <section class="pb-a-21 current-popular" id="related-game">
            <div class="container">
              ...
              <div class="text-center mt-5">
                     <router-link to="/games" class="router_link btn--collision br-40 border-1 secondery-border gil-bold font-weight-bold py-2 pl-a-6 pr-a-6 d-inline-block position-relative">{{ $t('all_games', $store.state.locale) }}</router-link>
              </div>
            </div>
        </section>
    </div>
