<template>
    <div>
        ...
        <section class="new-post pb-a-11 pt-a-9">
         ...
         <!-- Play station sell post -->
        <section class="new-post pb-a-11">
            <div class="container">
                <h3 class="f-s-24 gil-bold text-white mb-a-4">{{ $t('console_post', $store.state.locale) }}</h3>
                <!-- carousel -->
                <div class="position-relative carousel-nav">
                  <carousel v-if ="loadLatestPosts"
                            :autoplay ="false"
         ...
         <!-- Controller sell post -->
        <section class="new-post pb-a-11">
            <div class="container">
                <h3 class="f-s-24 gil-bold text-white mb-a-4">{{ $t('accessories_post', $store.state.locale) }}</h3>
                <!-- carousel -->
                <div class="position-relative carousel-nav">
                  <carousel v-if ="loadLatestPosts"
                            :autoplay ="false"
                ...
                <div class="text-center mt-5">
                     <router-link to="/sell-posts" class="router_link btn--collision br-4 border-1 secondery-border gil-bold font-weight-bold py-2 pl-a-6 pr-a-6 d-inline-block position-relative">All post</router-link>
                </div>
            </div>
        </section>
        <!-- sell post -->
