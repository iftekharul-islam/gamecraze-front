                ...
                <div class="col-md-6 mx-auto">
                    <div class="login-form">
                        ...
                        <ul class="nav nav-pills mb-3 d-flex justify-content-between" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-registration-tab" data-toggle="pill" href="#pills-registration" role="tab" aria-controls="pills-registration" aria-selected="false">CREATE AN ACCOUNT</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <!-- registration -->
                            <div class="tab-pane fade" id="pills-registration" role="tabpanel" aria-labelledby="pills-registration-tab">...</div>
                        </div>
...
<!--&lt;!&ndash;                                            <ValidationProvider name="number" rules="{ required: true, digits:11, regex:^(?=\d{10,11}$)(01)\d+ }" v-slot="{ errors }">&ndash;&gt;-->
<!--&lt;!&ndash;                                                <input type="tel" v-validate="{ regex: /^(?=\d{10,11}$)(01)\d+/ }" id="user-number" class="form-control country-number mb-2" v-model="phone_number"  placeholder="Mobile Number" autofocus />&ndash;&gt;-->
