                                  ...
                                  <span class="user-name" v-else>{{ this.$store.state.user.phone_number }}</span>
                                    ...
                                    <div class="dropdown-menu gamehub-dropdown-menu">
                                      <div class="gamehub-dropdown-menu--top">
                                        <router-link to="/sellpost" class="dropdown-item">{{ $t('dashboard', $store.state.locale) }}</router-link>
                                        <router-link to="/sellpost" class="dropdown-item" @click.native="clickProfile()">{{ $t('post_for_lend', $store.state.locale) }}</router-link>
