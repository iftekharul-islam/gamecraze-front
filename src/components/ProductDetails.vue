<template>
    <div>
        ...
        <div class="gamebazar-product-details pb-a-20">
            <div class="container">
                <router-link to="/gamebazar" class="router-link d-flex align-items-center mt-a-6 mb-a-6 svg-secondery-hover">
                    ...
                    <div class="col-md-6 pl-a-md-5">
                        <div class="gamebazar-product-details__content">
                            ...
                            <div class="gamebazar-product-details__content__des">
                                ...
                                <p>this ads only who are collaborator antiquities for sale used 
                                    retro machine 2001 PlayStation 2 slim NTSC U/ C model-77001 
                                    hard moded official original first edition console working 
                                    condition and smooth player. with 4 game cd listed shown 
                                    picture. 1 official controller , a/v, adopter,cod with 
                                    memory card its some time unsupported</p>
                               
                            </div>
                             <h2 class="f-s-34 gil-bold text-secondery mb-a-6">22,000 tk</h2>
                             <div class=" mt-5">
                                <router-link to="#" class="border-1 bg-secondery-gradient border-secondery-opa-25 primary-text primary-text-hover gil-bold py-2 pl-a-6 pr-a-6 d-inline-block br-4">Contact the seller</router-link>
                            </div>
                            <div class="row border-b-1 border-white-25 pt-a-6">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-a-6">
                                        ...
                                        <p class="text-white gil-regular">G123695932</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-a-6">
                                        <p class="text-white gil-bold mb-2">Avalability</p>
                                        <p class="before-ball d-flex align-items-center text-success-ball">In stock</p>
                                    </div>
                                    <div class="mb-a-6">
                                        <p class="text-white gil-bold mb-2">Warranty</p>
                                        <p class="before-ball d-flex align-items-center text-success-ball">12 years</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row pt-a-6">
                                <div class="col-md-6">
                                    <div class="">
                                        ...
                                        <p class="text-white gil-bold mb-4">Hosfos Game House</p>
