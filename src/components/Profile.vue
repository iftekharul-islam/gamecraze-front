                                                        ...
                                                        <!-- new offter design -->
                                                            ...
                                                            <div class="dashboard-content--rented--box position-relative bg-game-details border-2 warning-border" v-for="(rent, index) in rents" :key="index">
                                                                ...
                                                                <div class="dashboard-content--rented--box--order-name">
                                                                        <p v-if="rent.game" class="f-s-20 gil-bold mb-a-3 h-60 text-white">{{ rent.game.data.name }}</p>
                                                                </div>
                                                                <div class="d-flex flex-wrap">
                                                                    <div class="left flex-1">
                                                                        <div class="disk-condition">
                                                                            <p class="mb-2 text-white">{{ $t('disk_condition', $store.state.locale) }}</p>
                                                                        ...
                                                                        <div class="renter-name">
                                                                            <p class="mb-2 text-white">{{ $t('renter_name', $store.state.locale) }}</p>
                                                                    ...
                                                                    <div class="right flex-1 mt-5 mt-sm-0">
                                                                        <div class="platform">
                                                                            <p class="mb-2 text-white">{{ $t('platform', $store.state.locale) }}</p>
                                                                            <p class="text-secondery">{{ rent.platform.data.name }}</p>
                                                                        </div>
                                                                        <div class="status">
                                                                            <p class="mb-2 text-white">{{ $t('status', $store.state.locale) }}</p>
                                                                ...
                                                                <div class="d-flex flex-wrap" v-if="orders">
                                                                    <div class="dashboard-content--rented--box flex-wrap d-flex justify-content-between w-100 mr-0  bg-game-details border-2 warning-border" v-for="(order, index) in orders" :key="index">
                                                                        ...
                                                                        <div class="d-flex flex-column">
                                                                            ...
                                                                            <div>
                                                                                <p class="mb-1 text-white">{{ $t('status', $store.state.locale) }}</p>
                                                                ...
                                                                <div class="d-flex flex-wrap" v-if="sellPosts">
                                                                    <div class="dashboard-content--rented--box dashboard-content--rented--sell-post flex-wrap d-flex justify-content-between w-100 mr-0  bg-game-details border-2 warning-border" v-for="(product, index) in sellPosts" :class="{ 'inactive-sellpost-box' : sellPostWarning(product) }" :key="index">
                                                                        ...
                                                                        <div class="start-date d-flex flex-column">
                                                                            ...
                                                                            <label class="toggle-switch mt-0 mt-sm-1 h-60" v-if="product.status === 1">
