...
<!--                                                <select class="form-control mb-2" v-model="form.week">-->
...
<!--                                        <button class="btn btn-primary mb-2 text-white" v-bind:tooltip="rent.id" @click.prevent="handleSubmit(onAddToCart)"> Add to Cart<i class="fas fa-cart-plus"></i></button>-->
<!--        &lt;!&ndash;                                <button type="button" class="btn btn-primary mb-2" @click.prevent="onConform">Add to Cart <i class="fas fa-cart-plus"></i></button>&ndash;&gt;-->
<!--                                    </div>-->
<!--                                </ValidationObserver>-->
<!--                            </div>-->
<!--                        </div>-->
