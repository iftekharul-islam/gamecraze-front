                        ...
                        <div class="rating-list--box" v-for="(rating, index) in renterRating">
                            ...
                            <div class="d-flex flex-column flex-lg-row justify-content-between">
                                ...
                                <div class="rating-list--box--content mb-4 mb-lg-0 mr-lg-4 max-368">
                                    ...
                                    <p class="gil-bold gray-text f-s-16 mb-2">{{ $t('Lender', $store.state.locale) }}</p>
                                    <p class="text-white mb-4 gil-bold">{{ rating.lender.data.name }} {{ rating.lender.data.last_name }}</p>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$api.get('renter-rating-list?include=renter,lender,lend.rent.game, lend.order', config).then(response =>
            {
                this.renterRating = response.data.data;
                console.log(this.renterRating);
            });
        }
    }
</script>
